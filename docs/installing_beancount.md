...
<table><tbody><tr class="odd"><td><em>This document is about Beancount v2; Beancount v3 is in development and uses a completely different build and installation system. For instructions on building v3, see <a href="installing_beancount_v3.html"><span class="underline">this document</span></a>.</em></td></tr></tbody></table>
