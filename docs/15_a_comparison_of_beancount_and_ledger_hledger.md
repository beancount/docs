...
For this reason, a [<span class="underline">proposal has been written up</span>](http://furius.ca/beancount/doc/proposal-balance) to consider implementing file assertions in Beancount (in addition to its dated assertions). This will probably be carried out as a plugin. Ledger does not support dated assertions.
...
Note that handling those split transaction and merging them together will be handled; a [<span class="underline">proposal</span>](https://docs.google.com/document/d/1x0qqWGRHi02ef-FtUW172SHkdJ8quOZD-Xli7r4Nl_k/) is underway.
