<a id="title"></a>Beancount Scripting & Plugins
===============================================
...
<a id="load-pipeline"></a>Load Pipeline
---------------------------------------
...
<a id="writing-plug-ins"></a>Writing Plug-ins
---------------------------------------------
...
<a id="writing-scripts"></a>Writing Scripts
-------------------------------------------
...
### <a id="loading-from-file"></a>Loading from File
...
### <a id="loading-from-string"></a>Loading from String
...
### <a id="printing-errors"></a>Printing Errors
...
### <a id="printing-entries-round-tripping"></a>Printing Entries & Round-Tripping
...
<a id="executing-plugins"></a>Executing Plugins
-----------------------------------------------
